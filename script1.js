...
var vizInit = function () {
  ...
  function play() {
    ...
    var ball = new THREE.Mesh(torusGeometry, lambertMaterial);
    ball.position.set(0, 0, 0);
    group.add(ball);

    var torusGeometry = new THREE.SphereGeometry(15, 32, 16);
    var lambertMaterial = new THREE.MeshLambertMaterial({
      color: "white",
      transparent: true, 
       opacity: 0.1
    ...
    var ball2 = new THREE.Mesh(torusGeometry, lambertMaterial);
    ball2.position.set(0, 0, 0);
    group.add(ball2);

    var torusGeometry = new THREE.SphereGeometry(3, 5, 20);
    var lambertMaterial = new THREE.MeshLambertMaterial({
      color: "grey",
      // wireframe: true
      // transparent: true, 
    ...
    var ball3 = new THREE.Mesh(torusGeometry, lambertMaterial);
